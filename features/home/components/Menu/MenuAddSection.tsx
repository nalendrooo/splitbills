    ...
    return (
        <DropdownMenu >
            ...
            <DropdownMenuContent>
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem disabled={showDivideEvenly} onClick={() => setShowDivideEvenly(true)}>Sama Rata</DropdownMenuItem>
                <DropdownMenuItem onClick={() => setSection(prev => [...prev, initialForSome])}>Beberapa saja {section.length + 1}</DropdownMenuItem>
